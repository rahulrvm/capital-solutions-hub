      ...
      <div className="container mx-auto px-4 pt-24 pb-16 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-primary-foreground animate-fade-in">
            ...
            <p className="font-sans text-lg text-cream/80 max-w-xl mb-8 leading-relaxed">Customised liquidity, balance-sheet optimisation, and structured capital solutions for Corporates, SMEs and MSMEs across India.</p>
